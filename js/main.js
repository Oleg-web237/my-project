...
// БРОНИРОВАНИЕ ДОМИКА - END


// КНОПКА ОТКРЫТЬ ЗАКРЫТЬ ГАЛЕРЕЮ
...
showMoreBtn.addEventListener('click', function () {
  ...
  // ПРОВЕРЯЕМ ЕСТЬ ЛИ active
  if (gallery.classList.contains('active')) {
    showMoreBtn.textContent = 'Скрыть галерею';
  } else {
    showMoreBtn.textContent = 'Показать всю галерею';
  }
});
// КНОПКА ОТКРЫТЬ ЗАКРЫТЬ ГАЛЕРЕЮ--END
